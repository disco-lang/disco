...
with a link to the relevant Disco documentation.
    ...
    ⊆      U+2286            ``\subseteq``     ``subset``       :doc:`Subset of <container-ops>`
    ∪      U+222A            ``\cup``          ``union``        :doc:`Set union <container-ops>`
    ∩      U+2229            ``\cap``          ``intersect``    :doc:`Set intersection <container-ops>`
    ⨯      U+2A2F            ``\times``        ``><``           :doc:`Cartesian product <container-ops>`; :doc:`pair type <algebraic-types>`
