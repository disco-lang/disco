%% -*- mode: LaTeX; compile-command: "runhaskell Shake.hs" -*-
...
\onslide<8>
\begin{center}
  (or unparsing derivations, or untermination derivations, or \dots?)
\end{center}
\end{xframe}

\begin{xframe}{Example: STLC + natural numbers}
\begin{align*}
...
\begin{xframe}{Untyping?}
  \framebox{$\nty \Gamma t {\tau}$}
  \begin{overprint}
    \onslide<1>
    \begin{mathpar}
      \inferrule*[right=Mismatch]{\ty \Gamma t {\tau_1} \\ \tau_1 \neq \tau_2}{\nty
        \Gamma t {\tau_2}}
    \end{mathpar}
  \end{overprint}
\end{xframe}
