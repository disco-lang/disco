...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{infer}\mathbin{:}\Conid{Context}\to \Conid{Term}\to (\Conid{Error}\mathbin{+}\Conid{TypingDerivation}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{infer}\mathbin{:}\Conid{Context}\to \Conid{Term}\to (\neg\;\Conid{TypingDerivation}\mathbin{+}\Conid{TypingDerivation}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{infer}\mathbin{:}\Conid{Context}\to \Conid{Term}\to (\Conid{UntypingDerivation}\mathbin{+}\Conid{TypingDerivation}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
